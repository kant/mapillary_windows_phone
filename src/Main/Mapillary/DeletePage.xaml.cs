        ...
        private void rotateBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (m_selectedFile != null)
            {
                ...
                using (IsolatedStorageFile storage = IsolatedStorageFile.GetUserStoreForApplication())
                {
                    ...
                    using (var fileStream = storage.OpenFile(m_selectedFile.Path, FileMode.Open))
                    {
                    ...
                    using (IsolatedStorageFileStream targetStream = storage.OpenFile(m_selectedFile.Path, FileMode.Create, FileAccess.Write))
                    {
