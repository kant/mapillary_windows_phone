...
namespace ExifLibrary
{
    ...
    public abstract class ExifProperty
    {
        ...
        public abstract ExifInterOperability GetInteroperability(BitConverterEx.ByteOrder fileByteOrder);
    ...
    public class ExifURationalArray : ExifProperty
    {
        ...
        public override ExifInterOperability GetInteroperability(BitConverterEx.ByteOrder fileByteOrder)
        {
            return new ExifInterOperability(ExifTagFactory.GetTagID(mTag), 5, (uint)mValue.Length, ExifBitConverter.GetBytes(mValue, fileByteOrder));
        }
    }
